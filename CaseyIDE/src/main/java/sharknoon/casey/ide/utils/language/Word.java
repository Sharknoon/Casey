...
public enum Word {
    ...
    MENUBAR_OPTIONS_BACKGROUND_RELOAD_IMAGES,
    MENUBAR_OPTIONS_BACKGROUND_SET_DURATION_TEXT,
    MENUBAR_OPTIONS_BACKGROUND_SET_DURATION_SECONDS_TEXT,
    MENUBAR_OPTIONS_STYLE_TEXT,
    MENUBAR_OPTIONS_STYLE_DARK_TEXT,
    MENUBAR_OPTIONS_STYLE_LIGHT_TEXT,
    MENUBAR_OPTIONS_UPDATE_TEXT,
    MENUBAR_OPTIONS_ABOUT_TEXT,
    MENUBAR_PROJECT_TEXT,
    MENUBAR_PROJECT_OPEN_FOLDER_TEXT,
    MENUBAR_PROJECT_CLOSE_TEXT,
    //ToolBar
    TOOLBAR_BUTTON_SAVE_TEXT,
    TOOLBAR_BUTTON_RUN_TEXT,
    TOOLBAR_BUTTON_RUN_TOOLTIP,
    TOOLBAR_BUTTON_CODEVIEWER_TEXT,
    //Welcomesite
    ...
    //ParameterSite
    PARAMETER_SITE_CLASS_LABEL_TEXT,
    PARAMETER_SITE_FINAL_COMBOBOX_TEXT,
    PARAMETER_SITE_COMMENT_BUTTON_TEXT,
    PARAMETER_SITE_RENAME_BUTTON_TEXT,
    PARAMETER_SITE_DELETE_BUTTON_TEXT,
    //FunctionSite
    FUNCTION_SITE_COMMENT_CHILDREN_BUTTON_TEXT,
    FUNCTION_SITE_RENAME_CHILDREN_BUTTON_TEXT,
    FUNCTION_SITE_DELETE_CHILDREN_BUTTON_TEXT,
    FUNCTION_SITE_ADD_VARIABLE_BUTTON_TEXT,
    PARAMETER_SITE_ADD_PARAMETER_BUTTON_TEXT,
    FUNCTION_SITE_COMMENT_BUTTON_TEXT,
    FUNCTION_SITE_RENAME_BUTTON_TEXT,
    FUNCTION_SITE_DELETE_BUTTON_TEXT,
    ...
    FUNCTION_SITE_FUNCTION_LOGIC,
    FUNCTION_SITE_FUNCTION_VARIABLES_AND_PARAMETER,
    FUNCTION_SITE_FUNCTION_PARAMETERS,
    FUNCTION_SITE_FUNCTION_RETURNTYPE,
    //Dialogs
    ///New Project
    ...
    ///Save Project
    SAVE_DIALOG_TITLE,
    SAVE_DIALOG_EXTENSION_FILTER_CASEY_PROJECT,
    ///Open Project
    OPEN_DIALOG_TITLE,
    ///New Package
    ...
    ///Update available
    NEW_UPDATE_AVAILABLE_DIALOG_TITLE,
    NEW_UPDATE_AVAILABLE_DIALOG_HEADER_TEXT,
    NEW_UPDATE_AVAILABLE_DIALOG_CONTENT_TEXT,
    ///No Update available
    NO_NEW_UPDATE_AVAILABLE_DIALOG_TITLE,
    NO_NEW_UPDATE_AVAILABLE_DIALOG_HEADER_TEXT,
    //ValueSelectionPopup
    ...
    TYPE_SELECTION_POPUP_NO_TYPES,
    //TypeSelectionPopup
    TYPE_SELECTION_POPUP_PRIMITIVE_TYPES,
    TYPE_SELECTION_POPUP_OBJECT_TYPES,
    TYPE_SELECTION_POPUP_TITLE,
    //VariableSelectionField
    VARIABLE_SELECTION_FIELD_SELECT_VARIABLE,
    VARIABLE_SELECTION_POPUP_NO_TYPES,
    //VariableSelectionPopup
    VARIABLE_SELECTION_POPUP_TITLE,
    //Jar-Error Window
    EXECUTOR_ERROR_TITLE,
    EXECUTOR_ERROR_HEADER_TEXT,
    EXECUTOR_ERROR_CONTENT_TEXT,
    COMPILER_ENTER_PARAMETER_VALUES_DIALOG_TITLE,
    COMPILER_ENTER_PARAMETER_VALUES_DIALOG_HEADER_TEXT,
    COMPILER_ENTER_PARAMETER_VALUES_DIALOG_CONTENT_TEXT,
    //Run Window
    INPUT_OUTPUT_WINDOW_PROGRAM_ENDED,
    //General
    FUNCTION,
    PARAMETER,
    CLASS,
    ...
    DELETE,
    VOID,
    ITEM_NOT_COMPILED_DIALOG_TITLE, ITEM_NOT_COMPILED_DIALOG_HEADER_TEXT, ITEM_NOT_COMPILED_DIALOG_CONTENT_TEXT, HELP
}
