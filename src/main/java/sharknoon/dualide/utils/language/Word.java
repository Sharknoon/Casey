...
public enum Word {
    ...
    PROJECT_SIDE_COMMENT_BUTTON_TEXT,
    PROJECT_SIDE_DELETE_BUTTON_TEXT,
    ...
    PACKAGE_SIDE_COMMENT_PACKAGE_BUTTON_TEXT,
    PACKAGE_SIDE_COMMENT_CLASS_BUTTON_TEXT,
    PACKAGE_SIDE_COMMENT_FUNCTION_BUTTON_TEXT,
    PACKAGE_SIDE_COMMENT_VARIABLE_BUTTON_TEXT,
    PACKAGE_SIDE_RENAME_PACKAGE_BUTTON_TEXT,
    PACKAGE_SIDE_RENAME_CLASS_BUTTON_TEXT,
    PACKAGE_SIDE_RENAME_FUNCTION_BUTTON_TEXT,
    PACKAGE_SIDE_RENAME_VARIABLE_BUTTON_TEXT,
    PACKAGE_SIDE_DELETE_PACKAGE_BUTTON_TEXT,
    PACKAGE_SIDE_DELETE_CLASS_BUTTON_TEXT,
    PACKAGE_SIDE_DELETE_FUNCTION_BUTTON_TEXT,
    PACKAGE_SIDE_DELETE_VARIABLE_BUTTON_TEXT,
    //Dialogs
    ///New Project
