 ...
 * @since 9
 */
public class FixedSpinnerSkin<T> extends SkinBase<Spinner<T>> {
     ...
     */
    /**
     * Creates a new SpinnerSkin instance, installing the necessary child nodes
     * into the Control {@link Control#getChildren() children} list, as well as
     * the necessary input mappings for handling key, mouse, etc events.
     *
     * @param control The control that this skin should be installed onto.
     */
    public FixedSpinnerSkin(Spinner<T> control) {
        super(control);
...
//        control.setInputMap(behavior.getInputMap());
        ...
        control.addEventFilter(KeyEvent.ANY, ke -> {
            if (control.isEditable()) {
                ...
                //Fix for Dialogs needing the enter key for the default ok button
