...
public enum Word {
    ...
    LENGTH,
    DELETE,
    COMPILER_ERROR_CONTENT_TEXT, COMPILER_ERROR_HEADER_TEXT, COMPILER_ERROR_TITLE, VOID, COMPILER_ENTER_PARAMETER_VALUES_DIALOG_TITLE,
    COMPILER_ENTER_PARAMETER_VALUES_DIALOG_HEADER_TEXT,
    TOOLBAR_BUTTON_RUN_TOOLTIP, INPUT_OUTPUT_WINDOW_PROGRAM_ENDED, COMPILER_ENTER_PARAMETER_VALUES_DIALOG_CONTENT_TEXT
}
