...
public class Parameter extends Item<Parameter, Item<? extends Item, ? extends Item, Parameter>, Item<? extends Item, Parameter, ? extends Item>> implements Returnable<Type> {
